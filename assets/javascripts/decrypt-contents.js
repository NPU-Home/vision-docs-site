...
function decryptor_reaction(key_or_keys, password_input, decrypted_content, fallback_used=false) {
    if (key_or_keys) {
        ...
        let encrypted_something = {'md-nav md-nav--secondary': ['nav', 'class'], 'md-source-file__fact': ['span', 'class']};
        ...
        let reload_scripts = ['js/zoom.js', 'https://cdn.jsdelivr.net/npm/mathjax@3/es5/tex-mml-chtml.js'];
